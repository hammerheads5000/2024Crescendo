...
public class RaiseToAmpCommand extends Command {
  TrapMechanismSubsystem trapSubsystem;

  /** Creates a new RaiseToAmpCommand. */
  public RaiseToAmpCommand(TrapMechanismSubsystem trapSubsystem) {
